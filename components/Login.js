...
// <ActivityIndicator />
   ...
   axios.post('https://eventventure.pk/wedding_service_api/api/login',dataForm)
   .then(res => {
     let result = res.data;
     console.log(result);
     if(!result.error){
      ...
      try {
       ...
       //AsyncStorage.multiSet([["user_id", result.userdata.user_id.toString()], ["pincode",result.userdata.pincode], ["loggedIn", "true"]], (err, data) => {
          AsyncStorage.setItem('userToken', '25d55ad283aa400af464c76d713c07ad')

       //   AsyncStorage.multiSet([['userToken','25d55ad283aa400af464c76d713c07ad'], ["user_email",result.userdata.user_email], ["loggedIn", "true"]]
       // });
         // )
